...
`
    ...
    /** Hard coded Comment value for testing **/
    let userEnteredContent = "Trial Comment";
    ...
    /**
     * 5. Create Signed Comment Typed Data
     */
...
`
    ...
    let saveComment = async () => {
        ...
        try {
            const signedResult = await signCreateCommentTypedData(createCommentRequest, accessTokenFromLens)
            ...
            <div>
                ...
                {:else}
                    ...
                    <div class="btn-div">
                        ...
                        <button on:click={saveComment} class="btn">Comment Trial Text</button>
                    </div>
                {/if}
            </div>
        {/if}
